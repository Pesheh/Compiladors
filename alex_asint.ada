...
{IDENTIFIER}                        {rl_identifier(YYLVal, YYPos, yytext); 
                                     RETURN Identif;}
{NUMBER}                            {rl_literal_ent(YYLVal, YYPos, yytext);
                                     RETURN Lit;}
{STRING}                            {rl_literal_str(YYLVal, YYPos, yytext); 
                                     RETURN Lit;}
{CHARACTER}                         {rl_literal_car(YYLVal, YYPos, yytext); 
                                     RETURN Lit;}
{COMMENT}                           {null;}
{SEPARATOR}                         {null;}
.                                   {RETURN Error;}
...
%%
  ...
  package a_lexic is
    ...
    -- Auxiliar functions to allow external packages use these *_dfa 
    -- functions
